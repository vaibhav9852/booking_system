...
useEffect(()=>{
 setTotalGuest(bookingCtx.guest.adult + bookingCtx.guest.children)
  ...
  const cardRef = useRef(null);  // Ref to the card component 

  // Function to handle clicks outside the card
  const handleClickOutside = (event) => {
    if (cardRef.current && !cardRef.current.contains(event.target)) {
    //  setIsCardVisible(false);  // Hide the card when clicking outside
      showAuth(false)
      alert('hit')
    }
  };

  // Set up event listener to detect clicks outside when the component is mounted
  useEffect(() => {
...
// // Some basic styles for the card
// const styles = {
//   card: {
//     width: '200px',
//     padding: '20px',
    ...
    return (
        <>
         ...
         {/* <Guest /> */}
                ...
                <div className=' w-24 h-10  shadow-md  border-2 rounded-full relative'>
                    ...
                    {showAuth && <AuthCard ref={cardRef} updateFun={setShowAuth}/>}
                </div>
            </div>

            <div className='flex    justify-center  text-sm  font-semibold'>
            <div className='flex   items-center  my-5  w-11/12 sm:w-2/3  h-max shadow-md border-2 rounded-full'>
